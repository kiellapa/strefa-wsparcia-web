    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center min-h-screen">
        ...
        <div className="text-left animate-fade-in">
          <div className="inline-flex items-center space-x-2 bg-clay-soft/50 px-4 py-2 rounded-full mb-8 animate-gentle-pulse">
            <Sparkles className="w-4 h-4 text-primary" />
            <span className="text-sm text-primary font-medium">Profesjonalna psychoterapia</span>
          </div>
          
          <h1 className="text-5xl lg:text-7xl font-light text-foreground mb-6 leading-tight animate-fade-in-up animate-delay-100">
            <span className="block font-serif">Strefa</span>
            <span className="block text-primary font-medium">Wsparcia</span>
          </h1>
          
          <div className="mb-8 animate-slide-in-left animate-delay-200">
