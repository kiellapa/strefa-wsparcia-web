...
export const Twitter = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-12.7 12.5 4 1.2 8.1-.9 9.1-2.6-1.5-.9-2.5-2.6-2.5-2.6 1.4.2 2.1.2 2.1.2-.5 1.5-2 2.6-2 2.6 1.3-.4 2.1-1.1 2.1-1.1-1.6-1.5-2.4-3.5-2.4-3.5z" />
  </svg>
);